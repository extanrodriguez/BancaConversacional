...
def _faq_text(
    ...
    *,
    ...
    # Azure Search real antes de FAQ local para conocimiento (excepto cuando
    # el glosario local es la fuente canónica de «saldo disponible» y Search no aporta).
        ...
        if fields and fields[0] == "movements":
            return [TaskEvidence(
                ...
                text=(
                    ...
                    "no está disponible en este momento; para conocerlos contacte "
                    "los canales disponibles del banco."
                ),
                source="capability",
            )]
        return [TaskEvidence(
